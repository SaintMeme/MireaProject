package ru.mirea.pak.mireaproject.ui.micro;
...
import ru.mirea.pak.mireaproject.databinding.FragmentMicroBinding;

public class MicroFragment extends Fragment {
    private final String TAG = MicroFragment.class.getSimpleName();
